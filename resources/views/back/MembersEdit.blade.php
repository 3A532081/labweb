...
@section('content')
    ...
    <div class="row justify-content-center">
        <form action="/back/members/{{$members->id}}" method="POST" role="form" enctype ="multipart/form-data">{{ csrf_field() }}
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="name_en" type="text" class="form-control" name="name_en" value="{{$members->name_en}}" required>
                            </div>
                        </div>
                        {{--級--}}
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="year" type="text" class="form-control" name="year" value="{{$members->year}}" required>
                            </div>
                        </div>
                        {{--班級--}}
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="class" type="text" class="form-control" name="class" value="{{$members->class}}" required>
                            </div>
                        </div>
                        {{--專長--}}
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="skill" type="text" class="form-control" name="skill" value="{{$members->skill}}" required>
                            </div>
                        </div>
                        {{--Email--}}
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="email" type="text" class="form-control" name="email" value="{{$members->email}}" required>
                            </div>
                        </div>
                        {{--新增--}}
                        <div class="form-group row">
