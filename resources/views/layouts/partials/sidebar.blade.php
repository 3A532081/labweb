...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        {{--<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">--}}
            ...
            {{--<span class="icon-bar"></span>--}}
        {{--</button>--}}
        <a class="navbar-brand" href="{{ route('home') }}"><font color="#ffffff" face="微軟正黑體">lab後台</font></a>
    </div>
    <!-- Top Menu Items -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li>
                <a href="{{ route('home') }}"><font color="#ffffff" face="微軟正黑體"><i class="fa fa-home"></i>  Home</font></a>
            </li>
            <li>
                <a href="{{ route('back.members') }}"><font color="#ffffff" face="微軟正黑體"><i class="fa fa-users"></i>　lab成員管理</font></a>
            </li>
            <li>
                <a href="{{ route('back.papers') }}"><font color="#ffffff" face="微軟正黑體"><i class="fa fa-users"></i>　老師paper管理</font></a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
